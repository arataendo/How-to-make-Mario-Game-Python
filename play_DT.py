...
def play_mario(model_path):
    ...
    context_len = 30
    target_return = 500.0  # ★「スコア1000(クリア)を目指せ」という指示
    ...
    while not done:
        ...
        rtgs_input = torch.ones((1, states_input.shape[1], 1), dtype=torch.float32).to(device)
        # ==========================
        if len(actions) == 0:
...
if __name__ == "__main__":
    ...
    model_weight_path = r"C:\Users\arata\esslab\Mario-DT\mario_dt_epoch_10.pth" 
